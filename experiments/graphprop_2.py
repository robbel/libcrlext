...
agent_bigalp2 = Agent("glue_bigalp cfgs/default.xml.100-3.15 data/Gnp100_msp.txt -w /home/philipp/Desktop/experiments/Coordination_Discovery/graphprop/data_sort_15a-3.15_disc_tula/weights0.txt", cwd="/home/philipp/Builds/maastricht/3rdParty/libcrlext/graphprop");
agent_bigalp3 = Agent("glue_bigalp cfgs/default.xml.100-3.15 data/Gnp100_msp.txt -w /home/philipp/Desktop/experiments/Coordination_Discovery/graphprop/data_sort_15a-3.15_disc_tula/weights15.txt -b /home/philipp/Desktop/experiments/Coordination_Discovery/graphprop/data_sort_15a-3.15_disc_tula/conj15.txt", cwd="/home/philipp/Builds/maastricht/3rdParty/libcrlext/graphprop");

env_echo = Environment("echo run an environment")
glue_graphprop1 = Environment("glue_graphprop cfgs/default.xml.100-3.15 data/Gnp100_msp.txt", cwd="/home/philipp/Builds/maastricht/3rdParty/libcrlext/graphprop")
...
instances = [
    ...
    Instance("BIGALP15", agent_bigalp3, glue_graphprop1, steps=num_steps, trials=num_trials, runs=num_runs),
]
