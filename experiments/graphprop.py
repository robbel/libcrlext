...
#glue_graphprop1_viz = Environment("glue_graphprop cfgs/default.xml data/rand30/Rand2.txt --enable-stdout | ./bin/gvizz.py cfgs/default.xml data/rand30/Rand2.txt", cwd="/home/philipp/Builds/maastricht/3rdParty/libcrlext/graphprop")
