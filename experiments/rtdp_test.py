...
agent_rtdp1 = Agent("expert_maze_agent "+maze+" "+cfg+" rtdp 1 0.001 25 500 10", cwd=cwd)
agent_rtdp2 = Agent("expert_maze_agent "+maze+" "+cfg+" rtdp 1 0.001 50 500 10", cwd=cwd)
agent_rtdp3 = Agent("expert_maze_agent "+maze+" "+cfg+" rtdp 1 0.001 100 500 10", cwd=cwd)
agent_rtdp4 = Agent("expert_maze_agent "+maze+" "+cfg+" rtdp 1 0.001 500 500 10", cwd=cwd)
...
instances = [
    Instance("VI", agent_vi, env, trials=1000, runs=3),
    #Instance("PS", agent_ps, env, trials=1000, runs=3),
    Instance("RTDP_25", agent_rtdp1, env, trials=1000, runs=6),
