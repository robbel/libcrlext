...
agent_rtdp1h = Agent("expert_maze_agent "+maze+" "+cfg+" rtdp 1 0.1 25 500 10 1", cwd=cwd)
agent_rtdp1he0 = Agent("expert_maze_agent "+maze+" "+cfg+" rtdp 1 0 25 500 10 1", cwd=cwd)
agent_rtdp2 = Agent("expert_maze_agent "+maze+" "+cfg+" rtdp 1 0.1 50 500 10 0", cwd=cwd)
agent_rtdp3 = Agent("expert_maze_agent "+maze+" "+cfg+" rtdp 1 0.1 100 500 10 0", cwd=cwd)
agent_rtdp4 = Agent("expert_maze_agent "+maze+" "+cfg+" rtdp 1 0.1 500 500 10 0", cwd=cwd)
...
instances = [
    Instance("VI", agent_vi, env, trials=2000, runs=9),
    #Instance("PS", agent_ps, env, trials=1000, runs=3),
    Instance("RTDP_25", agent_rtdp1, env, trials=2000, runs=9),
    Instance("RTDP_25_H", agent_rtdp1h, env, trials=2000, runs=9),
    Instance("RTDP_25_H_e0", agent_rtdp1he0, env, trials=2000, runs=9),
